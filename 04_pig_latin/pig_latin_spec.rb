...
#
# (There are a few more rules for edge cases,
# and there are regional variants too,
# but that should be enough to understand the tests.)
#
# See <http://en.wikipedia.org/wiki/Pig_latin> for more details.
#
# you will have to work with strings and arrays, maybe have a look at
# the documentation:
# - https://ruby-doc.com/core/String.html
# - https://ruby-doc.com/core/Array.html
