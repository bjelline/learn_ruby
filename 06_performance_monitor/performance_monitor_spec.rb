...
# # Performance Monitor
#
# This is (a stripped down version of) an actual useful concept:
# a function that runs a block of code and then tells you how long it took to run.
...
describe 'Performance Monitor' do
  let(:eleven_am) { Time.parse('2011-1-2 11:00:00') }
